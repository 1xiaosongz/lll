...
if __name__ == "__main__":
    ...
    c = {merged[i + 1] for i in range(len(merged) - 1) if merged[i + 1] - merged[i] < 35}
    # 从a和b中剔除c中的元素
    ...
    # # 使用示例：
    # # 从第3个文件开始画（索引为2）
    # plot_ecg_segments(file_paths, ecg, R_dot_3, T_dot_3, ecg_size, start_index=80)
