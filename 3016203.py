...
def simple_extract(arr):
    ...
    def one_pass(current_arr):
        ...
        while i < len(current_arr) - 1:
            if current_arr[i + 1] - current_arr[i] == 674:
    ...
    #     i = 0
    #     while i < len(current_arr) - 1:
    #         if  current_arr[i + 1] - current_arr[i] < 700:
    #             extracted.append(current_arr[i + 1])
    #             current_arr.pop(i + 1)
    #         else:
    #             i += 1
...
def simple_extract_4(arr):
    ...
    def one_pass(current_arr):
        ...
        i = 0
        while i < len(current_arr) - 1:
            if current_arr[i + 1] - current_arr[i] < 470:
                extracted.append(current_arr[i + 1])
                current_arr.pop(i + 1)
            else:
                i += 1
...
if __name__ == "__main__":
    ...
    T_dot_18, issues_R_3 = simple_extract_1(T_dot_17)
    ...
    T_dot_22, issues_R_3 = simple_extract_1(T_dot_21)
    ...
    R_dot_24, issues_T_2 = simple_extract_4(R_dot_23)
    T_dot_24 = T_dot_23 + issues_T_2
    T_dot_24.sort()

    T_dot_25, issues_R_3 = simple_extract_1(T_dot_24)
    R_dot_25 = R_dot_24 + issues_R_3
    R_dot_25.sort()

    R_dot_26, issues_T_2 = simple_extract(R_dot_25)
    T_dot_26 = T_dot_25 + issues_T_2
    T_dot_26.sort()

    T_dot_27, issues_R_3 = simple_extract_1(T_dot_26)
    R_dot_27 = R_dot_26 + issues_R_3
    R_dot_27.sort()
