...
def simple_extract(arr):
    ...
    def one_pass(current_arr):
        ...
        while i < len(current_arr) - 1:
            if  current_arr[i + 1] - current_arr[i] == 451:
...
def simple_extract_3(arr):
    ...
    def one_pass(current_arr):
        ...
        i = 0
        while i < len(current_arr) - 1:
            if 480 < current_arr[i + 1] - current_arr[i] < 520:
                extracted.append(current_arr[i + 1])
                current_arr.pop(i + 1)
            else:
                i += 1
...
if __name__ == "__main__":
    ...
    R_dot_3,issues_T = simple_extract_2(R_dot_2)
    T_dot_3 = T_dot_2 + issues_T
    T_dot_3.sort()

    T_dot_8, issues_R_2 = simple_extract_2(T_dot_3)
    R_dot_8 = R_dot_3 + issues_R_2
    R_dot_8.sort()

    T_dot_6, issues_R_1 = simple_extract_3(T_dot_8)
    R_dot_6 = R_dot_8 + issues_R_1
    R_dot_6.sort()

    R_dot_10, issues_T_2 = simple_extract_2(R_dot_6)
    T_dot_10 = T_dot_6 + issues_T_2
    T_dot_10.sort()
    T_dot_6, issues_R_1 = simple_extract_2(T_dot_10)
    R_dot_6 = R_dot_10 + issues_R_1
    R_dot_6.sort()
    R_dot_11, issues_T_2 = simple_extract_2(R_dot_6)
    T_dot_11 = T_dot_6 + issues_T_2
    T_dot_11.sort()
    T_dot_12, issues_R_1 = simple_extract(T_dot_11)
    R_dot_12 = R_dot_11 + issues_R_1
    R_dot_12.sort()

    R_dot_13, issues_T_2 = simple_extract_2(R_dot_12)
    T_dot_13 = T_dot_12 + issues_T_2
    T_dot_13.sort()
